...
const Nav = ({ size, setShow }) => {
  return (
    <div className="flex justify-between ">
      <div className="hidden md:flex justify-between w-full p-8 border-b-2">
          ...
          <div className="">
            <ul className="flex gap-3 mt-0 sm:mt-8">
              <NavigationMenu>
                <NavigationMenuList>
                  <NavigationMenuItem>
                    <NavigationMenuTrigger className="mr-1">
                      Categories
                    </NavigationMenuTrigger>
                    <NavigationMenuContent>
      ...
      <div className="xl:hidden p-5 flex items-center justify-end w-full">
        <AlertDialog>
          <AlertDialogTrigger>
            <RxHamburgerMenu className="cursor-pointer w-5 h-5" />
          </AlertDialogTrigger>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle></AlertDialogTitle>
              <AlertDialogDescription>
                <div className="flex flex-col-reverse gap-10 w-full p-8 border-b-2 ">
                  <div className="flex gap-0 md:gap-5">
                    <div>
                      <Link to="/">
                        <div
                          ...
                          <NavigationMenuList>
                            <NavigationMenuItem>
                              ...
                              <NavigationMenuContent>
                                ...
                                <div className="flex p-6 gap-10 md:flex-row">
                                  <div className="flex flex-col gap-5">
                                    <div>
                                      <Link to="/men">
                                        <div className="flex items-center gap-3 p-5 hover:bg-gray-200">
